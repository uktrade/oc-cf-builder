...
ENV STATICFILE_BUILDPACK_VERSION=1.4.28 \
    JAVA_BUILDPACK_VERSION=4.12 \
    RUBY_BUILDPACK_VERSION=1.7.19 \
    NODEJS_BUILDPACK_VERSION=1.6.25 \
    GO_BUILDPACK_VERSION=1.8.23 \
    PYTHON_BUILDPACK_VERSION=1.6.17 \
    PHP_BUILDPACK_VERSION=4.3.56 \
    BINARY_BUILDPACK_VERSION=1.0.19 \
